...
public class ProfitsDto {
    private final Map<Name, Integer> entryProfits;
    private final int dealerProfit;

    private ProfitsDto(Map<Name, Integer> entryProfits, int dealerProfit) {
    ...
    public static ProfitsDto from(Profits profits) {
        ...
        return new ProfitsDto(mapEntryProfits(profitValues),
                profitValues.get(findDealer(profitValues)).getValue());
    }
    ...
    private static Map<Name, Integer> mapEntryProfits(Map<Player, Profit> profitValues) {
    ...
    public Map<Name, Integer> getEntryProfits() {
        return entryProfits;
    }
